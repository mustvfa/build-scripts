...
repo init -u https://github.com/Evolution-X/manifest -b bka --git-lfs                                                                                                                                    git clone https://github.com/samsungexynos850/local_manifests  -b slsi .repo/local_manifests
/opt/crave/resync.sh
